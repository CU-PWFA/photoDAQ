...
def config_instruments(DAQ, stage_cam):
    ...
    if stage_cam.serial == '17571186':
        ...
        DAQ.send_command(stage_cam, 'set_height', 1000)
        DAQ.send_command(stage_cam, 'set_width', 1000)
        DAQ.send_command(stage_cam, 'set_offsetX', 364)
        DAQ.send_command(stage_cam, 'set_offsetY', 300)
